...
HD_PWD='D:/Programming/MODELSIM/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logi_get.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logi_get.tcl
